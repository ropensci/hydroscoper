...
This vignette requires an internet connection to run and that the Hydroscope's subdomains to be online.
We can check if the sub-domains are online using the `pingr` package:

```{r}
library(pingr)

# helper function to print if a sub-domain is online
