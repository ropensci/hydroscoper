...
The Hydroscope's data sets are in Greek, thus limiting their usefulness, and raw time series values  are well structured as space separated text files. 
...
* `get_timeseries` to retrieve a tidy data frame with a station's time series. 
